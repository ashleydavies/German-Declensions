...
/* Generated by Opal 0.10.5 */
Opal.modules["constants"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $hash2 = Opal.hash2;

  return (function($base) {
    var $Constants, self = $Constants = $module($base, 'Constants');

    var def = self.$$proto, $scope = self.$$scope, TMP_1;

    Opal.defs(self, '$definiteArticle', TMP_1 = function $$definiteArticle() {
      var self = this;
      if (self.definiteArticle == null) self.definiteArticle = nil;

      return self.definiteArticle;
    }, TMP_1.$$arity = 0);

    self.definiteArticle = $hash2(["maskulinum", "femininum", "neutrum", "plural"], {"maskulinum": $hash2(["nominativ", "akkusativ", "dativ", "genitiv"], {"nominativ": "der", "akkusativ": "den", "dativ": "dem", "genitiv": "des"}), "femininum": $hash2(["nominativ", "akkusativ", "dativ", "genitiv"], {"nominativ": "die", "akkusativ": "die", "dativ": "der", "genitiv": "der"}), "neutrum": $hash2(["nominativ", "akkusativ", "dativ", "genitiv"], {"nominativ": "das", "akkusativ": "das", "dativ": "dem", "genitiv": "des"}), "plural": $hash2(["nominativ", "akkusativ", "dativ", "genitive"], {"nominativ": "die", "akkusativ": "die", "dativ": "den", "genitive": "der"})});
  })($scope.base)
};
...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$puts', '$[]', '$definiteArticle']);
  self.$require("opal");
  self.$require("constants");
  return self.$puts($scope.get('Constants').$definiteArticle()['$[]']("maskulinum")['$[]']("nominativ"));
})(Opal);
